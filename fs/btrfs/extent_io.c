...
static void end_bio_extent_writepage(struct bio *bio, int err)
{
	...
	if (unlikely(err)) {
		...
		ZBTRFS_LOG_IO_ERROR(fs_info, NULL/*bdev*/, bio, err);
	}
#endif /*CONFIG_BTRFS_ZADARA*/
...
#ifdef CONFIG_BTRFS_ZADARA
		zbtrfs_metadata_page_flushed(fs_info, btrfs_header_generation(eb));
#endif /*CONFIG_BTRFS_ZADARA*/
...
#ifdef CONFIG_BTRFS_ZADARA
	if (ZBTRFS_WARN(ZBTRFS_IS_BLKVIRT_MOUNT(BTRFS_I(inode)->root->fs_info),
		            "FS[%s]: Should not be called with Zadara block-virt on-disk format!!!", BTRFS_I(inode)->root->fs_info->sb->s_id))
		return -ECANCELED;
#endif /*CONFIG_BTRFS_ZADARA*/
