...
extern int qla24xx_walk_and_build_prot_sglist(struct qla_hw_data *, srb_t *,
	uint32_t *, uint16_t, struct qla_tc_param *);
extern struct qla_dfcport * qla_dfcp_create(struct scsi_qla_host *vha,
	uint8_t *port_name);
extern void qla_dfcp_free_entries(struct scsi_qla_host *vha);
extern void qla_dfcp_put(struct scsi_qla_host *vha, struct qla_dfcport *df);
...
extern int ql2xpci_manual_claim;
...
extern struct workqueue_struct *qla_work_q;
...
extern int qla83xx_modify_vp_config(scsi_qla_host_t *vha,
	struct vp_config_entry_24xx *vpmod_in);
